...
const turnApiUrl = 'https://pubsub.pubnub.com/v1/blocks/sub-key/sub-c-7a1edf60-9ad8-11e9-95d5-d6b10db480fa/turn-credentials';
let turnToken;
...
const initWebRtcApp = () => {
    ...
    pubnub = new PubNub({
        publishKey : 'pub-c-09c64f65-692c-4c44-87d6-7f983a53a25d',
        subscribeKey : 'sub-c-7a1edf60-9ad8-11e9-95d5-d6b10db480fa'
